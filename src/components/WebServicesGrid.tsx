  ...
  return (
    ...
    <div
      className="group flex flex-col p-6 md:p-8 lg:p-10 border border-gray-100 rounded-lg shadow-sm bg-white 
                 ...
                 hover:border-transparent hover:ring-2 hover:ring-orange-500" // Attractive hover effect
    >
      ...
      <div className="space-y-2 mb-6">
        {service.details.map((detail, index) => (
          <div key={index} className="flex items-center">
            ...
            <span className="inline-block h-2 w-2 mr-3 rounded-full bg-orange-400 flex-shrink-0"></span>
      ...
      <div className="flex justify-end mt-auto pt-4">
        <div className="p-3 rounded-full border border-gray-200 text-gray-500 group-hover:border-orange-500 group-hover:text-orange-500 transition duration-300 ease-in-out">
          <ArrowRight />
        </div>
      </div>
    </div>
