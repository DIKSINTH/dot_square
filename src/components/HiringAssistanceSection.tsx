...
const ArrowPointer: React.FC = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-4 w-4 text-orange-500 flex-shrink-0 mt-1"
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
    ...
    <div className="bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col h-full relative border border-gray-200">
      ...
      <div className="p-6 sm:p-8 flex-grow flex flex-col">
        ...
        <div className="mt-auto pt-6 border-t border-gray-100">
          ...
          <a
            href="#"
            className="flex items-center text-sm font-semibold text-orange-500 hover:text-orange-600 transition-colors"
          >
            Explore more
            <svg
              xmlns="http://www.w3.org/2000/svg"
