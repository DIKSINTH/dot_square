  ...
  return (
    <div className="group relative overflow-hidden rounded-lg shadow-xl aspect-[4/3] sm:aspect-video md:aspect-[4/3] lg:aspect-video">
      ...
      <div className="relative p-6 h-full flex flex-col justify-between">
        {/* Category & Title */}
        <div>
          <p className="text-xs font-semibold text-orange-400 mb-2 uppercase tracking-widest opacity-80 transition-opacity duration-300 group-hover:opacity-100">
            {category}
          </p>
    ...
    <section className="bg-black py-16 md:py-24 font-sans">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <p className="text-sm uppercase text-orange-400 tracking-[0.25em] font-semibold mb-2">
            CASE STUDIES
          </p>
